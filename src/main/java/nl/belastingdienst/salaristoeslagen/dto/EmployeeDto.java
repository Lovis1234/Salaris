...
public class EmployeeDto {
    ...
    public EmployeeDto(Long id, String firstName, String lastName, LocalDate birthday, int companyId, String city, double commuteKm, double salary, String address, double hoursAWeek) {
        this.id = id;
